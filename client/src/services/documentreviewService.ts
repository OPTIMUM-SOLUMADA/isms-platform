...
export const documentReviewService = {
    ...
    getMyReviews: async (
        ...
        axios.get(api.GET_MY_REVIEWS(id), {
            params: { page: filter.page, limit: filter.limit, status: filter.status },
        }),
    getMyReviewsStats: async (id: string) =>
        axios.get(api.GET_MY_REVIEWS_STATS(id)),
    ...
    getMyReviewsDueSoon: async (id: string) =>
        axios.get(api.GET_MY_REVIEWS_DUE_SOON(id)),
    getSubmittedReviews: async (id: string) =>
        axios.get(api.GET_SUBMITTED_REVIEWS_BY_DOCUMENT(id)),
    getCompletedReviews: async (id: string) =>
        axios.get(api.GET_COMPLETED_REVIEWS_BY_DOCUMENT(id)),
    getExpiredReviews: async (id: string) =>
