...
const buttonVariants = cva(
  'inline-flex uppercase items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default:
          'bg-theme text-primary-foreground shadow hover:bg-theme/90',
        destructive:
          'bg-theme-danger text-destructive-foreground shadow-sm hover:bg-theme-danger/90',
        outline:
          'border border-input bg-background shadow-sm hover:bg-accent hover:text-accent-foreground',
        secondary:
          'bg-secondary text-secondary-foreground shadow-sm hover:bg-secondary/80',
        primary:
          'bg-theme-2 text-foreground shadow-sm hover:bg-theme-2/80',
