    ...
    showCompare = true
        ...
        const PresetButton = ({
            ...
            <Button
                className={cn(
                    'normal-case',
                    isSelected && 'pointer-events-none bg-white text-theme-2-dark btn-sm border'
                )}
                variant="ghost"
                onClick={() => {
                    setPreset(preset)
            ...
            >
                <PopoverTrigger asChild>
                    <Button size={'sm'} variant="outline">
                        ...
                        <div className="px-2 opacity-60 -mr-2 scale-125">
                            {isOpen ? (<ChevronUpIcon width={10} />) : (<ChevronDownIcon width={10} />)}
                        </div>
                    </Button>
                </PopoverTrigger>
                <PopoverContent align={align} className="w-auto">
                    <div className="flex py-2 bg-gray-50 px-4">
                        <div className="flex">
                            <div className="flex flex-col gap-2">
                                <div className="flex flex-col lg:flex-row gap-2 px-0 justify-end items-center lg:items-start pb-4 lg:pb-0">
                                    {showCompare && (
